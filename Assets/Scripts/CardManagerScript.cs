...
public class CardManagerScript : MonoBehaviour
{
    public void Awake()
    {
        CardManager.AllCards.Add(new Card("Bluegill", "Sprites/Cards/Bluegill", 5, 5, 6));
        CardManager.AllCards.Add(new Card("Core", "Sprites/Cards/Core", 4, 3, 5));
        CardManager.AllCards.Add(new Card("Dalaran", "Sprites/Cards/Dalaran", 3, 3, 4));
        CardManager.AllCards.Add(new Card("Magma", "Sprites/Cards/Magma", 2, 1, 2));
        CardManager.AllCards.Add(new Card("Murloc", "Sprites/Cards/Murloc", 8, 1, 7));
        CardManager.AllCards.Add(new Card("Voodoo", "Sprites/Cards/Voodoo", 1, 1, 1));
        ...
        CardManager.AllCards.Add(new Card("DAMAGE_ENEMY_FIELD_CARDS", "Sprites/Cards/damageEnemyFieldCards", 0, 0, 2, 0, 
            Card.SpellType.DAMAGE_ENMY_FIELD_CARDS, 2, Card.TargetType.NO_TARGET));
        ...
        CardManager.AllCards.Add(new Card("BUFF_CARD_DAMAGE", "Sprites/Cards/buffCardDamage", 0, 0, 2, 0, 
            Card.SpellType.BUFF_CARD_DAMAGE, 2, Card.TargetType.ENEMY_CARD_TARGET));
